...
class UpdateChecker(QObject):
    ...
    def __init__(self):
        ...
        self.github_api_url = "https://api.github.com/repos/videoripper/TelegramFileDownloader/releases/latest"
        self.headers = {
            "User-Agent": f"TelegramLabsDownloader/{VERSION} ({platform.system()} {platform.release()})",
    ...
    def check_for_updates(self):
        ...
        try:
            response = requests.get(self.github_api_url, headers=self.headers, timeout=42)
